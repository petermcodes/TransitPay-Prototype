...
/// <summary>
/// Audit trail of terminal DELETE operations. When an admin deletes a terminal,
...
public class TerminalDeleteHistory
{
    ...
    /// <summary>The ID of the original (terminals) record that was deleted.</summary>
