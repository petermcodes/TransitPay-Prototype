...
/// <summary>
/// Audit trail of passenger EDIT operations. When an admin edits a passenger account,
...
public class PassengerEditHistory
{
    ...
    /// <summary>The ID of the original (users) record that was edited.</summary>
