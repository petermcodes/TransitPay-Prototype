...
/// <summary>
/// Audit trail of fare matrix DELETE operations. When an admin deletes a fare rule,
...
public class FareMatrixDeleteHistory
{
    ...
    /// <summary>The ID of the original (fare_rules) record that was deleted.</summary>
