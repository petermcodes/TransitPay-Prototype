...
/// <summary>
/// Audit trail of passenger DELETE operations. When an admin deletes a passenger
/// account, a JSON snapshot of the deleted record is stored here for forensics.
/// Newer records are always read-only append-only — never updated or deleted.
/// </summary>
[Table("passenger_delete_history")]
public class PassengerDeleteHistory
{
