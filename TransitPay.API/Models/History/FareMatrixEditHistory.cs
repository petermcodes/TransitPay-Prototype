...
/// <summary>
/// Audit trail of fare matrix EDIT operations. When an admin edits a fare rule,
...
public class FareMatrixEditHistory
{
    ...
    /// <summary>The ID of the original (fare_rules) record that was edited.</summary>
